...
python src/holosoma/holosoma/train_agent.py \
    ...
    --logger.name=g1_29dof_phuma_future_diverse_action_scale_normalize_finetune \
    --logger.video.enabled False \
    --training.checkpoint="logs/holosoma/20260506_g1_29dof_phuma_future_diverse_action_scale/model_104000.pt" \
